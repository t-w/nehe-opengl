/*
 * This code was created by Bosco(bosco4@home.com) and Jeff Molofee '00 
...
int wiggleCount;            /* how fast the flag waves */
...
int initGL(GLvoid)
{
    ...
    for (x = 0; x < 45; x++)
    {
        ...
        for (y = 0; y < 45; y++)
        {
            ...
            points[x][y][2] = (float)(sin((((x / 5.0f) * 40.0f) / 360.0f) *
                3.141592654 * 2.0f));
        }
    }
...
int drawGLScene(GLvoid)
{
    ...
    glEnd();
    /* move the wave every third frame */
    if (wiggleCount == 2)
    {
        for (y = 0; y < 45; y++)
        {
