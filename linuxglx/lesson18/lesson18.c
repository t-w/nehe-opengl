...
GLUquadricObj *quadratic;           /* pointer to our quadratic objects */
...
/* function for drawing our good old cube :-) */
GLvoid drawCube()
{
    glBegin(GL_QUADS);
        /* front face */
...
int drawGLScene(GLvoid)
{
    ...
    switch (object)
    {
        ...
        case 1:                     /* draw a cylinder */
            ...
            break;
        case 2:                     /* draw a CD-like disc */
            gluDisk(quadratic, 0.5f, 1.5f, 32, 32);
            break;
        case 3:                     /* draw a sphere */
        ...
        case 4:                     /* draw a cone */
            ...
            break;
        case 5:                     /* draw a partial disc without texture */
...
void keyPressed(KeySym key)
{
    switch (key)
    {
        ...
        case XK_Left:
            speedY -= 0.01f;
            break;
        case XK_space:                  /* cycle through the objects */
            object++;
